...
namespace CGUI
{
    ...
    internal class DoubleBufferedVMWareSVGAII
    {
        #region Headers
        ...
        internal void SetMode(uint width, uint height, uint depth = 32)
        {
        ...
        internal void WriteRegister(Register register, uint value)
        {
        ...
        internal uint ReadRegister(Register register)
        {
            IndexPort.DWord = (uint)register;
        ...
        internal void SetPixel(uint x, uint y, uint color)
        {
        ...
        /// <returns>uint value.</returns>
        /// <exception cref="Exception">Thrown on memory access violation.</exception>
        internal uint GetPixel(uint x, uint y)
        {
        ...
        internal void Clear(uint color)
        {
        ...
        /// <param name="height">Height.</param>
        /// <exception cref="NotImplementedException">Thrown if VMWare SVGA 2 has no rectange copy capability</exception>
        internal void Copy(uint x, uint y, uint newX, uint newY, uint width, uint height)
        {
        ...
        /// <exception cref="Exception">Thrown on memory access violation.</exception>
        /// <exception cref="NotImplementedException">Thrown if VMWare SVGA 2 has no rectange copy capability</exception>
        internal void Fill(uint x, uint y, uint width, uint height, uint color)
        {
        ...
        /// </summary>
        internal DoubleBufferedVMWareSVGAII()
        {
        ...
        internal void DoubleBuffer_SetPixel(uint x, uint y, uint color)
        {
            if (x < width)
            {
        ...
        internal void DoubleBuffer_DrawFillRectangle(uint x, uint y, uint width, uint height, uint color)
        {
        ...
        internal virtual void DoubleBuffer_DrawImage(Image image, uint x, uint y)
        {
        ...
        internal virtual void DoubleBuffer_DrawLine(uint color, int x1, int y1, int x2, int y2)
        {
        ...
        internal virtual void DoubleBuffer_DrawRectangle(uint color, int x, int y, int width, int height)
        {
